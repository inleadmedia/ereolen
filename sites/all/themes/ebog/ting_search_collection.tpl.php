      ...
      <div class="right">
        ...
        <div class="icons">
          <ul>
            ...
            ?>
              <li><?php print l(t('Sample'), $elib[$isbn]['elib_sample_link'], array('html' => true, 'attributes' => array('target' => '_blank',))) ?></li>
              <li class="seperator"></li>
              <li><?php print l(t('Loan'), 'publizon/' . $isbn . '/download', array('html' => true)) ?></li>
              <li class="seperator"></li>
